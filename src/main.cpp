...
int main(int argc, char* argv[])
{
    ...
    scene->addCamera( "*Volante", -0.12, 1.0, -0.12, 0.0, 1.0, 0.0, true, false);
    ...
    // LUCES
    // Luz por defecto, sin ninguna coloracion especial, casi blanca
    GLfloat light0_ambient_c[4]  = {   1.0f, 1.0f, 1.0f, 1.0f };
	GLfloat light0_diffuse_c[4]  = {   0.9f, 0.9f, 0.9f, 1.0f };
	GLfloat light0_specular_c[4] = {   1.0f, 1.0f, 1.0f, 1.0f };
	GLfloat light0_position_c[4] = { -30.0f, 20.0f, 10.0f, 1.0f };
	...
	GLfloat light1_diffuse_c[4]  = { 0.4f,   0.1f,  0.1f, 1.0f };
	GLfloat light1_specular_c[4] = { 1.0f,   1.0f,  1.0f, 1.0f };
	GLfloat light1_position_c[4] = { 30.0f, 15.0f, 50.0f, 1.0f };
	intensity = 0.4f;
    scene->addLight("Luz 1 Atardecer", GL_LIGHT1, 0, light1_position_c, intensity, light1_ambient_c, light1_diffuse_c, light1_specular_c);

    GLfloat light2_ambient_c[4]  = { 1.0f,   1.0f,  1.0f, 1.0f };
	GLfloat light2_diffuse_c[4]  = { 0.2f,   0.6f,  0.4f, 1.0f };
	...
	GLfloat light3_diffuse_c[4]  = { 0.4f,   0.4f,  0.8f, 1.0f };
	GLfloat light3_specular_c[4] = { 1.0f,   1.0f,  1.0f, 1.0f };
	GLfloat light3_position_c[4] = { 20.0f, 10.0f, -50.0f, 1.0f };
	intensity = 0.35f;
	...
	GLfloat light4_diffuse_c[4]  = { 0.2f,   0.2f,  0.8f, 1.0f };
	GLfloat light4_specular_c[4] = { 1.0f,   1.0f,  1.0f, 1.0f };
	GLfloat light4_position_c[4] = { 0.0f, 5.0f, 0.0f, 1.0f };
	intensity = 0.3f;
